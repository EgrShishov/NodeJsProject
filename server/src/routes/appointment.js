...
const { auth, ensureAuthenticated, ensureGuest, ensurePatinet, ensureReceptionist, ensureRole } = require('../middleware/auth');
...
router.get('/schedule/:patientId', auth, ensurePatinet, appointmentController.getPatientAppointment);
